...
namespace sweetSystem.UserControls
{
    partial class OrderManagementControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            _txSearch.PlaceholderText = "🔍 بحث باسم العميل أو رقم الطلب...";
            ...
            _cbFilter.Items.AddRange(new object[] { "الكل", "قيد الانتظار", "تم التكليف", "مكتمل" });
